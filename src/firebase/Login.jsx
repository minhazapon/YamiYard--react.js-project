...
const Login = () => {
    ...
    const {signIn, googleA} = useContext(fireContext)
    ...
    return (
        ...
        <div className="   w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gradient-to-r from-green-500 to-orange-500 text-gray-100">
